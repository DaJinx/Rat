...
@onready var _camera: Camera3D = GlobalReferences.player.Camera
@onready var _lock_on_system: LockOnSystem = GlobalReferences.lock_on_system
...
func _ready():
	...
	GlobalReferences.user_interface.hud.wellbeing_widgets.add_child(_wellbeing_widget)
