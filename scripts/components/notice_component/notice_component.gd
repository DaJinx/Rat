...
@onready var camera: Camera3D = GlobalReferences.player.Camera


func _ready() -> void:
	notice_triangle = notice_triangle_scene.instantiate()
	GlobalReferences.user_interface.hud.notice_triangles.add_child(notice_triangle)
	notice_triangle.visible = false
	
	off_camera_notice_triangle = off_camera_notice_triangle_scene.instantiate()
	GlobalReferences.user_interface.hud.off_camera_notice_triangles.add_child(off_camera_notice_triangle)
