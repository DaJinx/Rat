...
# used for the GlobalReferences.resources key
...
func _ready():
	...
	if GlobalReferences.resources.has(animation_resource_key):
		_animation_library = GlobalReferences.resources[animation_resource_key]
		...
		GlobalReferences.resources[animation_resource_key] = _animation_library
