...
@onready var player: PlayerCharacter = GlobalReferences.player
@onready var camera_controller: CameraController = GlobalReferences.camera_controller
@onready var lock_on_system: LockOnSystem = GlobalReferences.lock_on_system
@onready var interaction_hints: InteractionHints = GlobalReferences\
	.user_interface\
	.hud\
	.interaction_hints
@onready var checkpoint_interface: CheckpointInterface = GlobalReferences\
	.user_interface\
...
func _recover() -> void:
	GlobalReferences.camera_controller.reset()
	...
	GlobalReferences.user_interface.hud.clear_enemy_hud_elements()
